...
@Component({
  selector: 'team-delayed-estimates',
  templateUrl: './delayed-estimates.component.html'
})
export class DelayedEstimatesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.afs
      ...
      .collection<any>('estimates', ref => ref.where('status', '==', 'delayed'))
