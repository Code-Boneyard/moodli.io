...
@Component({
  selector: 'team-submitted-estimates',
  templateUrl: './submitted-estimates.component.html'
})
export class SubmittedEstimatesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.afs
      ...
      .collection<any>('estimates', ref => ref.where('status', '==', 'submitted'))
