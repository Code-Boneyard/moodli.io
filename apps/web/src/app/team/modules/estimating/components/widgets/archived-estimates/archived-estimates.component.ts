...
@Component({
  selector: 'team-archived-estimates',
  templateUrl: './archived-estimates.component.html'
})
export class ArchivedEstimatesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.afs
      ...
      .collection<any>('estimates', ref => ref.where('status', '==', 'archived'))
