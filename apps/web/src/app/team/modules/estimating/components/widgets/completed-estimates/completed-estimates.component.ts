...
@Component({
  selector: 'team-completed-estimates',
  templateUrl: './completed-estimates.component.html'
})
export class CompletedEstimatesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.afs
      ...
      .collection<any>('estimates', ref => ref.where('status', '==', 'completed'))
